...
import com.project.springBoot.entity.SysPermission;
import com.project.springBoot.entity.SysRole;
import com.project.springBoot.entity.UserInfo;
import com.project.springBoot.service.UserInfoService;
...
public class MyShiroRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(
		...
		// 实际项目中，这里可以根据实际情况做缓存，如果不做，Shiro自己也有时间间隔机制，两分钟内不会重复执行该方法
